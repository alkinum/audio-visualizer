    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden p-6 transition-colors duration-300">
          ...
          <FileDropzone onFileSelect={handleFileSelect} isLoading={isLoading} isDarkMode={isDarkMode} />

          {error && <div className="mt-4 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-xl text-red-600 dark:text-red-400">{error}</div>}
          ...
          {selectedFile && !isLoading && !error && (
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-xl text-blue-700 dark:text-blue-400 flex items-center">
              ...
              <span className="ml-2 text-sm opacity-75">({(selectedFile.size / (1024 * 1024)).toFixed(2)} MB)</span>
            </div>
          )}

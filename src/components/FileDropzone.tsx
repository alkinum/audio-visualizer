...
const FileDropzone: React.FC<FileDropzoneProps> = ({ onFileSelect, isLoading, isDarkMode }) => {
  ...
  return (
    <div 
      className={`border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 cursor-pointer group ${
        isDragging 
          ? 'border-primary bg-primary-light/10 dark:border-primary-light dark:bg-primary-dark/20' 
          : 'border-gray-300 dark:border-gray-600 hover:border-primary dark:hover:border-primary-light hover:bg-gray-50 dark:hover:bg-gray-700/50'
      }`}
      ...
      <div className="flex flex-col items-center justify-center">
        {isLoading ? (
          ...
          <>
            ...
            <p className="text-lg font-medium text-gray-700 dark:text-gray-200 group-hover:text-primary dark:group-hover:text-primary-light transition-colors duration-300">
